...
import { Image, View, ScrollView, Text, ImageBackground } from "react-native";
import { Card, Title, Paragraph, DefaultTheme } from "react-native-paper";
              ...
              >
                ...
                <View style={styles.flex3}>
                  ...
                  >
                    ...
                    />
                    <Text style={styles.txtRute3}>Pesawat</Text>
                  </Card>
                </View>
                <View style={styles.flex3}>
                  <Card
                  ...
                  >
                    ...
                    />
                    <Text style={styles.txtRute2}>Hotel</Text>
                  </Card>
                </View>
                <View style={styles.flex3}>
                  <Card
                  ...
                  >
                    ...
                    />
                    <Text style={styles.txtRute1}>Bus & Travel</Text>
                  </Card>
                </View>
              </View>
            </View>
            ...
            >
              <View>
                ...
                >
                  ...
                  <View style={{ padding: 5 }}>
                    <Card style={{ width: 350, borderRadius: 5 }}>
                      <Card.Content>
                        <Card.Cover
                          source={{
                            uri:
